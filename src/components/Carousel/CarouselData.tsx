...
export const CAROUSEL_DATA = [
  ...
  { title: 'Container', src: ContainerIcon },
  { title: 'Group', src: GroupIcon },
  { title: 'Island', src: IslandIcon },
  { title: 'Layer', src: LayerIcon },
  { title: 'Mension', src: MensionIcon },
  { title: 'New', src: NewIcon },
  { title: 'Pool', src: PoolIcon },
  { title: 'Vector', src: VectorIcon },
];
